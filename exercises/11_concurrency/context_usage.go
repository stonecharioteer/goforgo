...
// TODO: Function that performs multiple operations with context
func processData(ctx context.Context, data []string) error {
	for i, item := range data {
		// TODO: Check if context is cancelled before each operation
		select {
		case <-ctx.Done():
		...
		// TODO: Simulate work with context-aware sleep
...
func authenticatedOperation(ctx context.Context) error {
	...
	// TODO: Simulate operation with context
	select {
...
func main() {
	...
	// TODO: Start operations with different durations
	operations := []struct {
		name     string
	...
	// TODO: Create context with timeout for worker pool
	...
	// TODO: Cancel parent after 500ms - should cascade to children
	...
	// TODO: Clean up remaining contexts
	childCancel()
