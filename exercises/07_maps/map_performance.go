...
func main() {
	// TODO: Create a map with initial capacity using make
	// Hint: make(map[keyType]valueType, capacity)
	largeMap := // Create map with initial capacity of 1000
	
	// TODO: Benchmark map insertion performance
	fmt.Println("Benchmarking map insertion...")
	
	start := time.Now()
	// Insert 10000 key-value pairs
	for i := 0; i < 10000; i++ {
		// Insert key-value pair where key is string and value is i*2
	}
	insertTime := time.Since(start)
	fmt.Printf("Time to insert 10,000 items: %v\n", insertTime)
	
	// TODO: Benchmark map lookup performance
	...
	// TODO: Compare map vs slice for membership testing
	...
	// TODO: Demonstrate map memory optimization
	...
	// TODO: Show that map retains memory even after deletions
	...
	// TODO: Demonstrate map iteration performance
	...
	start = time.Now()
	var sum int
	// TODO: Iterate through all key-value pairs and sum the values
	...
	// TODO: Show key collision example (advanced)
