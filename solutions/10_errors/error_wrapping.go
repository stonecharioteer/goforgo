...
// Custom error types for wrapping examples
...
// Low-level functions that return basic errors
...
// Mid-level functions that add more context
...
// Functions to demonstrate error unwrapping
...
// Function that demonstrates error joining (Go 1.20+)
...
// Custom multi-error type for pre-Go 1.20
...
func main() {
	...
	// Test authentication flow with multiple wrapping levels
	testUsers := []struct {
	...
	for i, input := range testInputs {
		...
		if err != nil {
			...
			// Check if it's a MultiError and process individual errors
	...
	// Demonstrate the difference between wrapping and not wrapping
