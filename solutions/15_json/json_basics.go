...
// Define structs for JSON operations
type Person struct {
...
func main() {
	...
	// Create a Person and marshal to JSON
	person := Person{
		Name:    "Alice Johnson",
		Age:     28,
	...
	// Create complex employee structure
	employee := Employee{
		ID: 1001,
		Person: Person{
			Name:    "Diana Prince",
	...
	empJSON, err := json.MarshalIndent(employee, "", "  ")
	if err != nil {
	...
	err = json.Unmarshal(empJSON, &newEmployee)
	if err != nil {
	...
	// Unmarshal JSON array back to slice
	var newPeople []Person
	err = json.Unmarshal(peopleJSON, &newPeople)
	if err != nil {
