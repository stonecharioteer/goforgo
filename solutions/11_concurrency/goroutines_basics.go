...
// Function that demonstrates goroutine execution order
...
// Function that shows goroutine with WaitGroup
...
// Function that returns a value through channel
...
func main() {
	...
	// Start concurrent number printing
	// Start printNumbers("Odd", 1, 5) as goroutine
	go printNumbers("Odd", 1, 5)
	// Start printNumbers("Even", 2, 6) as goroutine
	go printNumbers("Even", 2, 6)
